 ...
 * 轉職樹 + 關卡解鎖
 *
 * 路線／中文名對齊台服 TWMS（來源：artale-lottery-bot/leveling.js JOB_TREE）
 *
 * 冒險家：
 *   劍士 → 狂戰士→十字軍→英雄 ｜ 見習騎士→騎士→聖騎士 ｜ 槍騎兵→龍騎士→黑騎士
 *   法師 → 僧侶→祭司→主教 ｜ 火毒巫師→火毒魔導士→火毒大魔導 ｜ 冰雷巫師→…
 *   弓箭手 → 獵人→遊俠→箭神 ｜ 弩弓手→狙擊手→神射手
 *   盜賊 → 刺客→暗殺者→夜使者 ｜ 俠盜→神偷→暗影神偷
 *   海盜 → 打手→格鬥家→拳霸 ｜ 槍手→神槍手→槍神
 * 皇家：通關 S07 解鎖（1 轉定職）
 * 英雄團：通關 S09 解鎖
 */
